...
import { maleFirstNames } from '../data/sorted/male/male-first-names';
import { maleLastNames } from '../data/sorted/male/male-last-names';
import { femaleFirstNames } from '../data/sorted/female/female-first-names';
import { femaleLastNames } from '../data/sorted/female/female-last-names';
